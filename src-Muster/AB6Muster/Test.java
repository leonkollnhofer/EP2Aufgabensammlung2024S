...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nTest2:");
        IntVarConstMap values = new IntVarConstTreeMap();
        ...
        e = x.times(new IntConst(3)).plus(y);
        System.out.println(e);
        Condition cond1 = new IsEqual(e,new IntConst(2)); //3x + y = 2;
        Condition cond2 = new IsEqual(x, new IntConst(0)); // x = 0;
        Condition finalcond = new AND(cond1, cond2);

        IntVarConstMap map = new IntVarConstHashMap();
        map.put(x, new IntConst(0));
        map.put(y, new IntConst(2));
        System.out.println(finalcond.getValue(map)); //2 = 2 & 0 = 0
    }
