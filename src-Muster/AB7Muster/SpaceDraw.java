...
public class SpaceDraw {
    ...
    public static double massToRadius(double mass) {
        ...
        return AB1Muster.Simulation.SUN_RADIUS * (Math.pow(mass / AB1Muster.Simulation.SUN_MASS, 0.5));
    }
    ...
    public static Color massToColor(double mass) {
        Color color;
        if (mass < AB1Muster.Simulation.SUN_MASS / 10) {
