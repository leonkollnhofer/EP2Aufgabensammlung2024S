...
public class Body {
    ...
    /**
     * Initialises this body with mass, center of mass and the current movement vector.
     * @param mass
     * @param massCenter
    ...
    public void draw(CodeDraw cd) {
        ...
        this.massCenter.drawAsFilledCircle(cd, getRadius());
    }
    ...
    public String toString() {
        ...
        //TODO: implement method.
        return mass + " kg, position: " + massCenter + " m, movement: " + currentMovement + " m/s.";
    }
}
