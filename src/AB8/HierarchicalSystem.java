...
public interface HierarchicalSystem extends BodyIterable {
     ...
     * this system. The subsystem closest to the barycenter is listed first. If the distance is
     * equal for two subsystems within the system, the subsystem with the higher mass is listed
     * first. If two subsystems within this system have equal distance and mass, they are listed
     * alphabetically according to their name.
     *
     * Subsystems are indented by three space characters for each level of hierarchy
     * (indentation and ordering is applied recursively for subsystems within subsystems).
